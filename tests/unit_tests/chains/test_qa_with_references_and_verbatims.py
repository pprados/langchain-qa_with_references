...
from ._test_retriever import CALLBACKS, init_llm, logger, compare_words_of_responses, \
    compare_responses
                    ...
                    "map_reduce": (
                            {
                                ...
                                4: '{"response": "He eats apples, He eats pears, He eats carrots.", "documents": [{"ids": ["_idx_0"], "verbatims": ["He eats carrots."]}, {"ids": ["_idx_1", "_idx_2"], "verbatims": ["He eats apples", "He eats pears"]}]}',
...
def test_qa_with_reference_and_verbatims_chain(
    ...
    for i in range(0, 5):  # Retry if empty ?
