...
from langchain_qa_with_references.chains import (
    QAWithReferencesAndVerbatimsChain, RetrievalQAWithReferencesChain,
    RetrievalQAWithReferencesAndVerbatimsChain,
)
from ._tools_qa_with_references import (
    CALLBACKS,
    compare_responses,
    init_llm,
    logger, organize_result,
)
...
def test_qa_with_reference_and_verbatims_chain_and_retriever(chain_type: str) -> None:
    ...
    # Group each verbatims by sources (if the original document has been split)
