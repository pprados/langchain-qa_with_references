...
def load_qa_with_references_chain(
    ...
    **kwargs: Any,
    ...
    """Load question answering with only referenced documents and verbatim.

    When using the map_reduce mode, this implementation allows you to retrieve the list of documents, enriched with
    multiple verbatims extracted from each documents in metadata.
